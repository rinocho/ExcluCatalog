        ...
        <div className="fixed inset-0 z-50 bg-white dark:bg-gray-900 flex flex-col animate-in fade-in duration-200">
            ...
            <div className="flex-1 p-8 flex flex-col items-center justify-center gap-8">
                <div className="text-center max-w-md">
                    <div className="bg-blue-100 dark:bg-blue-900/30 p-6 rounded-full w-24 h-24 mx-auto mb-6 flex items-center justify-center text-blue-600 dark:text-blue-400">
                        <FileSpreadsheet size={48} />
                    </div>
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Carga de Inventario</h3>
                    <p className="text-gray-500 dark:text-gray-400">
                        Sube un archivo Excel (.xlsx o .csv) para actualizar el catálogo de productos.
                    </p>
                </div>
                ...
                <div className="w-full max-w-md">
                    ...
                    <button
                        ...
                        className={`w-full py-4 px-6 rounded-xl border-2 border-dashed flex items-center justify-center gap-3 transition-all ${status === 'success'
                    ...
                    {message && (
                        <p className={`mt-4 text-center font-medium ${status === 'success' ? 'text-green-600 dark:text-green-400' :
